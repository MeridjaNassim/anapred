...
import { APP_HOME, APP_DASHBOARD, APP_PATIENTS, APP_INTERVENTIONS, APP_STATISTIQUES, APP_PREDICTIONS, APP_PARAMETRES, APP_DOCS, APP_BASE_ROUTE } from '../../routes/routes';
